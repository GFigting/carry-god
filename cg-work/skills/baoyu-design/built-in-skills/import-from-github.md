...
When you need more than a few files, take a shallow sparse clone into a scratch location **outside** the project / design-system folder (`/tmp/ds-sources/<repo>` or `local/projects/<project-id>/design/_sources/<repo>`):

...
(`<skill>` is this skill's directory; `local/projects/<project-id>/design/<project>` is the design-system
folder.) Writes `local/projects/<project-id>/design/<project>/preview.html` by default. Open it directly
